...
class LineItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  #  line 29 is commented because of line 25 and line 32 is commented because of line 26 according to page no 142
  # assert_select 'h2', 'Your Pragmatic Cart'
  # assert_select 'li', 'Programming Ruby 1.9'
  # above line is commented because of next line according to page no 134
  ...
  test "should update line_item" do
    ...
    # following line commented because of above line according topage no 139
  ...
  # from line no 64 to 73 are added due to instruction given on page no 160
